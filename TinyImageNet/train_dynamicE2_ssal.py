...
from dataset import TinyImageNetDatasetAL,TinyImageNetDataset
...
n_classes = 200 # total class number

DEVICE = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

train_loss_file = "/home/wyx/vscode_projects/SSAL/models/TinyImageNet/DynamicE2/{}-{}/train_loss.csv".format(args.info, args.balance)
val_loss_file = "/home/wyx/vscode_projects/SSAL/models/TinyImageNet/DynamicE2/{}-{}/val_loss.csv".format(args.info, args.balance)
test_acc_file = "/home/wyx/vscode_projects/SSAL/models/TinyImageNet/DynamicE2/{}-{}/test_acc.csv".format(args.info, args.balance)
states_file_path = "/home/wyx/vscode_projects/SSAL/models/TinyImageNet/DynamicE2/{}-{}/states.json".format(args.info, args.balance)
best_model_path = "/home/wyx/vscode_projects/SSAL/models/TinyImageNet/DynamicE2/{}-{}/best_model.pth".format(args.info, args.balance)
