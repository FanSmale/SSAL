...
parser = argparse.ArgumentParser(description="TinyImageNet Baseline Running [Random, Entropy, LeastConfidence, Margin]")
...
train_loss_file = "/home/wyx/vscode_projects/SSAL/models/TinyImageNet/DynamicE2/{}/train_loss.csv".format(args.method)
val_loss_file = "/home/wyx/vscode_projects/SSAL/models/TinyImageNet/DynamicE2/{}/val_loss.csv".format(args.method)
test_acc_file = "/home/wyx/vscode_projects/SSAL/models/TinyImageNet/DynamicE2/{}/test_acc.csv".format(args.method)
best_model_path = "/home/wyx/vscode_projects/SSAL/models/TinyImageNet/DynamicE2/{}/best_model.pth".format(args.method)
