...
from dataset import CIFAR10Dataset,CIFAR10DatasetAL
...
train_loss_file = "/home/wyx/vscode_projects/SSAL/models/CIFAR10/DynamicE2/{}-{}/train_loss.csv".format(args.info, args.balance)
val_loss_file = "/home/wyx/vscode_projects/SSAL/models/CIFAR10/DynamicE2/{}-{}/val_loss.csv".format(args.info, args.balance)
test_acc_file = "/home/wyx/vscode_projects/SSAL/models/CIFAR10/DynamicE2/{}-{}/test_acc.csv".format(args.info, args.balance)
states_file_path = "/home/wyx/vscode_projects/SSAL/models/CIFAR10/DynamicE2/{}-{}/states.json".format(args.info, args.balance)
best_model_path = "/home/wyx/vscode_projects/SSAL/models/CIFAR10/DynamicE2/{}-{}/best_model.pth".format(args.info, args.balance)
...
# 读取数据
dataset_L, dataset_U = CIFAR10DatasetAL.createLURandomly(nL=1000, image_size=32)
train_loader_LU = ComposeLoaderLU(dataset_L, dataset_U, BATCH_SIZE)
dataset_test = CIFAR10Dataset(train=False, image_size=32)
