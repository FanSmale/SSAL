...
train_loss_file = "/home/wyx/vscode_projects/SSAL/models/CIFAR10/{}-{}/sup/train_loss.csv".format(args.info, args.balance)
val_loss_file = "/home/wyx/vscode_projects/SSAL/models/CIFAR10/{}-{}/sup/val_loss.csv".format(args.info, args.balance)
test_acc_file = "/home/wyx/vscode_projects/SSAL/models/CIFAR10/{}-{}/sup/test_acc.csv".format(args.info, args.balance)
states_file_path = "/home/wyx/vscode_projects/SSAL/models/CIFAR10/{}-{}/sup/states.json".format(args.info, args.balance)
best_model_path = "/home/wyx/vscode_projects/SSAL/models/CIFAR10/{}-{}/sup/best_model.pth".format(args.info, args.balance)
...
n_classes = CIFAR10Dataset.C # total class number
