...
parser = argparse.ArgumentParser(description="SVHN Baseline Running [Random, Entropy, LeastConfidence, Margin]")
...
train_loss_file = "/home/wyx/vscode_projects/SSAL/models/SVHN/DynamicE2/{}/train_loss.csv".format(args.method)
val_loss_file = "/home/wyx/vscode_projects/SSAL/models/SVHN/DynamicE2/{}/val_loss.csv".format(args.method)
test_acc_file = "/home/wyx/vscode_projects/SSAL/models/SVHN/DynamicE2/{}/test_acc.csv".format(args.method)
best_model_path = "/home/wyx/vscode_projects/SSAL/models/SVHN/DynamicE2/{}/best_model.pth".format(args.method)
...
model = unsupresnet.ResNet(unsupresnet.BasicBlock, [2, 2, 2, 2], num_classes=n_classes,f_kernel_size=7)
model.to(DEVICE)
