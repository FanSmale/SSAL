...
parser = argparse.ArgumentParser(description="CIFAR100 SSAL Running")
...
train_loss_file = "/home/wyx/vscode_projects/SSAL/models/CIFAR100/DynamicE2/{}-{}/train_loss.csv".format(args.info, args.balance)
val_loss_file = "/home/wyx/vscode_projects/SSAL/models/CIFAR100/DynamicE2/{}-{}/val_loss.csv".format(args.info, args.balance)
test_acc_file = "/home/wyx/vscode_projects/SSAL/models/CIFAR100/DynamicE2/{}-{}/test_acc.csv".format(args.info, args.balance)
states_file_path = "/home/wyx/vscode_projects/SSAL/models/CIFAR100/DynamicE2/{}-{}/states.json".format(args.info, args.balance)
best_model_path = "/home/wyx/vscode_projects/SSAL/models/CIFAR100/DynamicE2/{}-{}/best_model.pth".format(args.info, args.balance)
